...
public class AppRate {
    private final static String APP_TITLE = "Mathematics Grade 10th Teacher Guide";// App Name
    private static final String APP_PNAME = "com.beckytech.informationtechnologygrade10th";// Package Name
